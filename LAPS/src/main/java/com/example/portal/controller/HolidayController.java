...
public class HolidayController {
	...
	public String editHoliday(@PathVariable(name = "id") long id, Model model, Holiday h) {
	...
	@RequestMapping(path = "/home/{stringview}", method = RequestMethod.GET)
	public String viewHoliday(@PathVariable(value = "stringview") String view, Model model) {
